...
echo "<script type='text/javascript'> document.location = 'welcomef.php'; </script>";
} else{
...
body {
	...
	background-image: url("https://transcode-v2.app.engoo.com/image/fetch/f_auto,c_limit,h_384,dpr_3/https://assets.app.engoo.com/images/UrvmNzgHbpX9w5lpO0dPqsdvk5mYhdTa4aa8TTX95ng.gif");
...
<div class="signup-form">
    <form  method="post">
        ...
        <div class="form-group">
			<label class="form-check-label"><a href="resend-otpf.php">Resend OTP</a></label>
		</div>
		<div class="form-group">
			<button type="submit" class="btn btn-primary btn-block btn-lg" name="login">Sign Up</button>
		</div>	
    </form>
	<div class="text-center small">Not Signup yet ? <a href="indexf.php">Signup here</a></div>
</div>
</body>
</html>