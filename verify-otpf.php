...
//validation page
if($_SESSION['emailid']=='' ){
echo "<script>window.location.href='loginf.php'</script>";
}else{
...
echo "<script>window.location.href='file:///C:/Users/HP/OneDrive/Desktop/project/htdocs/testcase/seller.html'</script>";
}}
}
